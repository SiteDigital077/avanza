...
<div class="row">
    ...
    <div class="col-lg-12">
     <a href="/gestion/avanza/crear" type="button" class="btn btn-success btn-lg btn-block mb-5">CREAR FICHA</a>
    </div>
</div>
        ...
        <div class="d-flex">
            ...
            <div class="flex-shrink-0 mr-7 mt-lg-0 mt-3">
                <div class="symbol symbol-50 symbol-lg-120">
                    <img alt="Pic" src="{{$contenido->image}}"/>
                </div>
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    <div class="mr-3">
                        ...
                        <a href="#" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">
                            {{$contenido->title}} <i class="flaticon2-correct text-success icon-md ml-2"></i>
                        </a>
                        <!--end::Name-->
...
</svg><!--end::Svg Icon--></span>                                {{$contenido->email}}
                            </a>
                            <a href="#" class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
...
</svg><!--end::Svg Icon--></span>                                {{$contenido->telefono}}
                            </a>
        ...
        <path d="M9.82829464,16.6565893 C7.02541569,15.7427556 5,13.1079084 5,10 C5,6.13400675 8.13400675,3 12,3 C15.8659932,3 19,6.13400675 19,10 C19,13.1079084 16.9745843,15.7427556 14.1717054,16.6565893 L12,21 L9.82829464,16.6565893 Z M12,12 C13.1045695,12 14,11.1045695 14,10 C14,8.8954305 13.1045695,8 12,8 C10.8954305,8 10,8.8954305 10,10 C10,11.1045695 10.8954305,12 12,12 Z" fill="#000000"/>
...
</svg><!--end::Svg Icon--></span>                                {{substr($contenido->ubicacion, 0, 40)}}
                            </a>
                        </div>
                        <!--end::Contacts-->
                    </div>
                ...
                <div class="d-flex align-items-center flex-wrap justify-content-between">
                    <div class="flex-grow-1 font-weight-bold text-dark-50 py-5 py-lg-2 mr-5">
                        {!!wordwrap($contenido->position,74,"<br>\n")!!}
                    </div>
                    ...
                    <div class="d-flex flex-wrap align-items-center py-2">
                        <div class="d-flex align-items-center mr-10">
                            <div class="mr-6">
                                ...
                                <span class="btn btn-sm btn-text btn-light-primary text-uppercase font-weight-bold">{{$contenido->created_at}}</span>
                            </div>
                            <div class="">
                                <div class="font-weight-bold mb-2">Actualización</div>
                                <span class="btn btn-sm btn-text btn-light-danger text-uppercase font-weight-bold">{{$contenido->updated_at}}</span>
                            </div>
                        </div>
        ...
        <div class="d-flex align-items-center flex-wrap">
            ...
            <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                ...
                <div class="d-flex flex-column flex-lg-fill">
                    <span class="text-dark-75 font-weight-bolder font-size-sm">73 Reseñas</span>
            ...
            <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                ...
                <div class="d-flex flex-column">
                    <span class="text-dark-75 font-weight-bolder font-size-sm">648 Comentarios</span>
                    <a href="#" class="text-primary font-weight-bolder">Ver</a>
                </div>
            </div>
            <!--end: Item-->
