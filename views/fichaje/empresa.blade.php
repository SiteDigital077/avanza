     ...
     <div class="card-body"> 
      <div class="row">
       <div class="col-sm-2 col-md-2">
        <img width="90%" alt="Pic" src="{{$contenido->imagen}}">
       </div>
      ...
      <div class="text-right">
       <a href="#" class="site-button m-l10" data-toggle="modal" data-target="#exampleModal"> <span style="margin-right: 10px; font-size: 18px" class="fa fa-envelope text-right"></span> contactar</a>
      </div>     
     </div>
